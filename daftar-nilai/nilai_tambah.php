    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-primary">
          ...
          <!-- /.card-header -->
          <!-- form start -->
          <form action="input-nilai.php" method="post" enctype="multipart/form-data">
            <div class="card-body">
              <div class="form-group">
                ...
                <select name="nis" class="form-control">
                  ...
                  <?php
                  $sql_nama = mysqli_query($koneksi, "SELECT * FROM santri");
                  while ($data_santri = mysqli_fetch_array($sql_nama)) {
              ...
              <div class="form-group">
                <label>Tahfidz</label>
                <input type="number" name="tahfidz" class="form-control">
              </div>
              <div class="form-group">
                <label>Aqidah</label>
                <input type="number" name="aqidah" class="form-control">
              </div>
              <div class="form-group">
                <label>Fiqih</label>
                <input type="number" name="fiqih" class="form-control">
              </div>
              <div class="form-group">
                <label>Tajwid</label>
              ...
              <div class="form-group">
                ...
                <input type="number" name="mahfudlot" class="form-control">
              </div>
              <div class="form-group">
                <label>Persholatan</label>
                <input type="number" name="persholatan" class="form-control">
              </div>
              <div class="form-group">
                <label>Imla'/Khot</label>
                <input type="number" name="imla" class="form-control">
              </div>
              <div class="form-group">
