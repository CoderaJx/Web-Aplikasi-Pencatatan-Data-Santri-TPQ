            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title" style="margin-right: 20px;">
                  <a href="tambah.php" class="btn btn-success" type="button"><i class="fa fa-plus-circle"></i>&nbsp Tambah Data</a></h3>
...
while($d =mysqli_fetch_array($c)){
  ...
  ?>
    ...
    <td>
        <a class="btn btn-block btn-danger" href="hapus.php?id_pengumuman=<?php echo $d['id_pengumuman']; ?>" onclick="return confirm('Hapus Data?');" ><i class="fas fa-trash"></i></a>         
    </td>
