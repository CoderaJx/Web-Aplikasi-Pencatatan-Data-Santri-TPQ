...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      <!-- Brand Logo -->
      <a href="daftar_santri.php" class="brand-link">
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          ...
          <li class="nav-item">
            <a href="daftar_santri.php" class="nav-link">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Halaman Daftar Santri</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title" style="margin-right: 20px;">
                  <a href="santri_tambah.php" class="btn btn-success" type="button"><i class="fa fa-plus-circle"></i>&nbsp Tambah Data</a></h3>
                  <a href="cetak.php" target="_blank" class="btn btn-warning" type="button"><i class="fas fa-columns"></i>&nbsp Print Data</a></h3>
...
while($d =mysqli_fetch_array($c)){
  ...
  ?>
    ...
    <td>
        <a class="btn btn-block btn-warning" href="santri_edit.php?nis=<?php echo $d['nis']; ?>" ><i class="fas fa-edit"></i></a>
    </td>
    <td>
        <a class="btn btn-block btn-danger" href="hapus_santri.php?nis=<?php echo $d['nis']; ?>" onclick="return confirm('Hapus Data?');" ><i class="fas fa-trash"></i></a>         
    </td>
