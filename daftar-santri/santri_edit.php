...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  <div class="content-wrapper">
    ...
    <?php 
    $id = $_GET['nis'];
    $query_mysql = mysqli_query($koneksi, "SELECT * FROM santri WHERE nis='$id'");
    $nomor = 1;
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-primary">
          ...
          <!-- /.card-header -->
          <!-- form start -->
          <form action="update-santri.php" method="post" enctype="multipart/form-data">
            <div class="card-body">
              <div class="form-group">
                <label>Nama</label>
                <input type="text" name="nama_santri" value="<?php echo $data['nama_santri']; ?>" class="form-control">
              ...
              <div class="form-group">
                ...
                <input type="text" name="pekerjaan_ortu" value="<?php echo $data['pekerjaan_ortu']; ?>" class="form-control">
              </div>
              <div class="form-group">
                <label>Kelas</label>
                <input type="number" name="kelas" value="<?php echo $data['kelas']; ?>" class="form-control">
              </div>
